...
import com.substanceofcode.data.ItemIdAllocator;
...
public class Controller {
    ...
    private ItemIdAllocator idAllocator;
...
//FileSystem.getFileSystem().formatFileSystem();
        	idAllocator = ItemIdAllocator.getIdAllocator();
    ...
    public void addItem(String text) {
        ...
        long itemId = idAllocator.getNextItemId();
